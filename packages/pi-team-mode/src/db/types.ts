...
export interface CoordinationSessionRuntime {
	session_id: string;
	runtime_id: string;
	generation: number;
	pid?: number;
...
export interface SessionRuntimeWrite {
	session_id: string;
	runtime_id: string;
	pid?: number;
	process_identity?: Record<string, unknown>;
...
export interface CoordinationRuntimeEvent {
	event_id: string;
	session_id: string;
	runtime_id: string;
	generation: number;
...
export interface TeamDatabaseStatements {
	...
	get_session_runtime: StatementSync;
	insert_session_runtime: StatementSync;
	replace_session_runtime: StatementSync;
	adopt_session_runtime: StatementSync;
	heartbeat_session_runtime: StatementSync;
	transition_session_runtime: StatementSync;
	insert_runtime_event: StatementSync;
	list_runtime_events: StatementSync;
}
