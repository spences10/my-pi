...
| Workspace isolation  | Sessions record a cwd; peers may share it. No managed worktree or collision guarantee.                                           | Explicit collision rejection or deliberate workspace isolation.               | E: deterministic collision/isolation evidence.                                            |
