...
export const BUILTIN_EXTENSION_REGISTRY = [
	...
	},
	{
		key: 'talk',
		label: 'Talk',
		docs_label: 'Hold-Space dictation',
		description: 'Hold Space to dictate into the input editor',
		default_enabled: true,
		option_name: 'talk',
		cli_arg: 'no-talk',
		cli_flag: '--no-talk',
		cli_description: 'Disable hold-Space dictation',
		aliases: ['talk', 'voice', 'dictation'],
		external_package_name: '@spences10/pi-talk',
		mode_constraints: {
			disabled_in: ['print', 'json', 'rpc'],
			reason: 'Talk requires the interactive TUI',
		},
		load: async () => (await import('@spences10/pi-talk')).default,
	},
	{
		key: 'starfield',
		label: 'Starfield',
